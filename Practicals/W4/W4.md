...
This was not my best code and there are better ways to sort through tables but I tried to work on only what I knew and what was given. I used bash to print out the columns to then manually put them into the dictionary but could definitely be done easier another way
``` python
# Shebang
#!/usr/bin/env python3
